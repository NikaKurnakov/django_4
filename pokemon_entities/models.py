...
class PokemonEntity(models.Model):
    ...
    level = models.PositiveSmallIntegerField(verbose_name='Уровень', null=True, blank=True)
    health = models.PositiveIntegerField(verbose_name='Здоровье', null=True, blank=True)
    strength = models.PositiveSmallIntegerField(verbose_name='Атака', null=True, blank=True)
